...
namespace Bobcat
{
    public class DefaultArgumentGenerator : IArgumentGenerator
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        public DefaultArgumentGenerator(LaunchSettings launchSettings, ILauncherProfileParser launcherProfileParser,
        ...
        public IEnumerable<string> GenerateLaunchArguments()
        {
